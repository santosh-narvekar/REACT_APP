  ...
  return (
    ...
    gap-24 items-center'>
      <div>
        ...
        <p className='mt-8 max-w-xl text-lg leading-8'>Lorem ipsum dolor sit amet consectetur adipisicing elit. Quam harum iusto voluptatem quasi labore? Iusto quam ratione quia quis expedita dignissimos hic ad. Quisquam dolores similique quo inventore reiciendis porro!
        </p>
        <div className="mt-10">
